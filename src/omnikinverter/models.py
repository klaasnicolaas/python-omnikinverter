...
@dataclass
class WebResponse:
    """Holds an unparsed response from the connected Omnik."""
    ...
    def inverter(self) -> Inverter:
        ...
        Returns
        -------
            An Inverter data object from the Omnik Inverter.
...
@dataclass
class TcpResponse:
    """Holds an unparsed TCP response from the connected Omnik."""
